...
class VllmConfig:
    ...
    def _maybe_auto_enable_mtp(self) -> None:
        ...
        checkpoint silently run 2-3x slower than the weights they downloaded
        allow, and nothing in the model repo can change that -- it is an engine
        ...
        n_predict = n_predict or getattr(hf, "mtp_num_hidden_layers", None) or getattr(
            text, "mtp_num_hidden_layers", None
        )
